...
XCVAR_DEF( cg_animSpeed,						"1",					NULL,					CVAR_NONE )
...
XCVAR_DEF( cg_cameraOrbit,						"0",					NULL,					CVAR_NONE )
...
XCVAR_DEF( cg_debugAnim,						"0",					NULL,					CVAR_NONE )
XCVAR_DEF( cg_debugGun,							"0",					NULL,					CVAR_NONE )
XCVAR_DEF( cg_debugSaber,						"0",					NULL,					CVAR_NONE )
XCVAR_DEF( cg_debugPosition,					"0",					NULL,					CVAR_NONE )
XCVAR_DEF( cg_debugEvents,						"0",					NULL,					CVAR_NONE )
...
XCVAR_DEF( cg_noPlayerAnims,					"0",					NULL,					CVAR_NONE )
...
XCVAR_DEF( cl_paused,							"0",					NULL,					CVAR_NONE )
XCVAR_DEF( com_buildScript,						"0",					NULL,					CVAR_NONE )
XCVAR_DEF( com_cameraMode,						"0",					NULL,					CVAR_NONE )
...
XCVAR_DEF( sv_running,							"0",					CG_SVRunningChange,		CVAR_NONE )
XCVAR_DEF( teamoverlay,							"0",					NULL,					CVAR_NONE|CVAR_USERINFO )
XCVAR_DEF( timescale,							"1",					NULL,					CVAR_NONE )
XCVAR_DEF( ui_about_gametype,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_fraglimit,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_capturelimit,				"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_duellimit,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_timelimit,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_maxclients,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_dmflags,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_mapname,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_hostname,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_needpass,					"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_about_botminplayers,				"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_myteam,							"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c0_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c1_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c2_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c3_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c4_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_c5_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm1_cnt,							"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c0_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c1_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c2_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c3_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c4_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_c5_cnt,						"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm2_cnt,							"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
XCVAR_DEF( ui_tm3_cnt,							"0",					NULL,					CVAR_NONE|CVAR_INTERNAL )
#undef XCVAR_DEF
