...
XCVAR_DEF( d_altRoutes,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_asynchronousGroupAI,		"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_break,						"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_JediAI,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_noGroupAI,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_noroam,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_npcai,						"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_npcaiming,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_npcfreeze,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_noIntermissionWait,		"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_patched,					"0",			NULL,				CVAR_NONE,										qfalse )
...
XCVAR_DEF( d_saberAlwaysBoxTrace,		"0",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( d_saberBoxTraceSize,			"0",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( d_saberCombat,				"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( d_saberGhoul2Collision,		"1",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( d_saberInterpolate,			"0",			NULL,				CVAR_NONE,										qtrue )
...
XCVAR_DEF( d_siegeSeekerNPC,			"0",			NULL,				CVAR_NONE,										qtrue )
...
XCVAR_DEF( g_allowNPC,					"1",			NULL,				CVAR_NONE,										qtrue )
...
XCVAR_DEF( g_duelWeaponDisable,			"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_NONE,		qtrue )
...
XCVAR_DEF( g_debugSaberLocks,			"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( g_debugServerSkel,			"0",			NULL,				CVAR_NONE,										qfalse )
#ifdef _DEBUG
...
XCVAR_DEF( g_ff_objectives,				"0",			NULL,				CVAR_NONE|CVAR_NORESTART,						qtrue )
XCVAR_DEF( g_filterBan,					"1",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_forceBasedTeams,			"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_NONE,		qfalse )
XCVAR_DEF( g_forceClientUpdateRate,		"250",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( g_forceDodge,				"1",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( g_forcePowerDisable,			"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_NONE,		qtrue )
...
XCVAR_DEF( g_gametype,					"0",			NULL,				CVAR_SERVERINFO|CVAR_NONE,						qfalse )
XCVAR_DEF( g_gravity,					"800",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( g_inactivity,				"0",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( g_jediVmerc,					"0",			NULL,				CVAR_SERVERINFO|CVAR_NONE|CVAR_ARCHIVE,		qtrue )
...
XCVAR_DEF( g_maxForceRank,				"7",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_NONE,		qfalse )
XCVAR_DEF( g_maxGameClients,			"0",			NULL,				CVAR_SERVERINFO|CVAR_NONE|CVAR_ARCHIVE,		qfalse )
XCVAR_DEF( g_maxHolocronCarry,			"3",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( g_motd,						"",				NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( g_needpass,					"0",			NULL,				CVAR_SERVERINFO|CVAR_NONE,						qfalse )
...
XCVAR_DEF( g_restarted,					"0",			NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( g_saberBladeFaces,			"1",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( g_saberDamageScale,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
#ifdef DEBUG_SABER_BOX
XCVAR_DEF( g_saberDebugBox,				"0",			NULL,				CVAR_NONE,										qfalse )
#endif
#ifndef FINAL_BUILD
XCVAR_DEF( g_saberDebugPrint,			"0",			NULL,				CVAR_NONE,										qfalse )
#endif
...
XCVAR_DEF( g_saberRealisticCombat,		"0",			NULL,				CVAR_NONE,										qfalse )
...
XCVAR_DEF( g_weaponDisable,				"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_NONE,		qtrue )
XCVAR_DEF( g_weaponRespawn,				"5",			NULL,				CVAR_NONE,										qtrue )
XCVAR_DEF( gamedate,					__DATE__,		NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( gamename,					GAMEVERSION,	NULL,				CVAR_SERVERINFO|CVAR_NONE,						qfalse )
...
XCVAR_DEF( sv_maxclients,				"8",			NULL,				CVAR_SERVERINFO|CVAR_NONE|CVAR_ARCHIVE,		qfalse )
